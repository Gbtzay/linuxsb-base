...
test('Greasy Fork：氢/氧对外名称与简介标明 Beta', () => {
  assert.match(baseCode, /@name\s+LINUX\.SB 氢（Beta）/)
  assert.match(suiteCode, /@name\s+LINUX\.SB 氧（Beta）/)
  assert.match(baseCode, /@name:en\s+LINUX\.SB Hydrogen \(Beta\)/)
  assert.match(suiteCode, /@name:en\s+LINUX\.SB Oxygen \(Beta\)/)
  assert.match(baseCode, /@description\s+【Beta】/)
  assert.match(suiteCode, /@description\s+【Beta】/)
  assert.match(baseCode, /@description:en\s+\[Beta\]/)
  assert.match(suiteCode, /@description:en\s+\[Beta\]/)
})
